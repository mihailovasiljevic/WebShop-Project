...
/**
 * Servlet implementation class IzmeniDodatneUslugeServlet
 */
public class IzmeniDodatneUslugeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IzmeniDodatneUslugeServlet() {
        super();
